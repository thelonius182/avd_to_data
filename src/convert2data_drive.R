...
rlprg_files <- dir_ls(path = "/home/lon/R_projects/avd_to_data/resources/AVD2DATA_files",
                      type = "file",
...
for (a_file in rlprg_files$value) {
  ...
  oe_data_file_name <- str_replace(a_file, pattern = "/AVD2DATA_files/", replacement = "/AVD2DATA_conv_files/")
